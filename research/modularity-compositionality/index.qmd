...
author:
  - name: Ed Henry
    ...
    affiliation: Zscaler
    affiliation-url: https://www.zscaler.com
date: "2026-04-11"
...
and domain-specific fine-tunes in production, these days in a
cybersecurity setting. A lot of the questions in this program come
directly from watching composition fail in ways the academic literature
doesn't quite capture yet, and often the failure is visible first to
whoever is trying to make the system misbehave on purpose.
:::
